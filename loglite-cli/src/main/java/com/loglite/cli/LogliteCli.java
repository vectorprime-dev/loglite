...
@Command(
        ...
        subcommands = {ConfigCommand.class, ProfilesCommand.class, PingCommand.class, QueryCommand.class, ParseCommand.class, WatchCommand.class, StatsCommand.class, UploadCommand.class})
